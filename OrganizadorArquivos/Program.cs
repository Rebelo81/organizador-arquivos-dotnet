...
public class Program
{
    ...
    public static void OrganizarArquivosRecursivo(string pasta, HashSet<string> ignorarExtensoes, StreamWriter log, string pastaRaiz, long? tamanhoMin, long? tamanhoMax, DateTime? dataMin, DateTime? dataMax)
    {
